...
-(void)viewDidLoad
{   //tab 背景颜色
//   self.tabButtonsContainerView.backgroundColor = [UIColor greenColor];
    //背景 图案
    UIColor *bgColor = [UIColor colorWithPatternImage: [UIImage imageNamed:@"noise-dark-blue.png"]];
    [self.tabButtonsContainerView setBackgroundColor:bgColor];
}
@end
